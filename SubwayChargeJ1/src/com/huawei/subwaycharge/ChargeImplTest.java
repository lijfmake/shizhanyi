...
public class ChargeImplTest {
	...
	public void testOpQuery() {
		...
		//q 9 20:10 19.10
		Assert.assertEquals(chargeImpl.opQuery(9, 20, 10, 19, 10).toString(),OpResult.createOpResult(ReturnCodeEnum.E01).toString());
		//q 0 00:00 23:59
		Assert.assertEquals(chargeImpl.opQuery(0, 0, 0, 23, 59).toString(),OpResult.createOpResult(ReturnCodeEnum.E21).toString());
		////25  q 0 20:00 23:59
		Assert.assertEquals(chargeImpl.opQuery(0,20,00,23,59).toString(), 
    	...
    	ChargeCmdInfo ci1 = new ChargeCmdInfo(1, CardTypeEnum.B, 100, 9,
				30, "S2", 9, 59, "S3");
    	ChargeCmdInfo ci2 = new ChargeCmdInfo(1, CardTypeEnum.A, 100, 10,
				30, "S3", 11, 59, "S4");
		...
		Assert.assertEquals(chargeImpl.opQuery(0,0,0,23,59).toString(), 
				OpResult.createOpResult(ReturnCodeEnum.I20).toString());
    	//27  q 1 8:00 9:00
